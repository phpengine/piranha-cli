...
install
    ...
    example: piranha install autopilot dev-client
    example: piranha install autopilot dev-client-silent
    example: piranha install autopilot dev-client-autogen
    ...
    example: piranha install autopilot dev-server
    example: piranha install autopilot dev-server-silent
    example: piranha install autopilot dev-server-autogen
    ...
    unattended install. You can also use the keyword autogen which will generate values for sensitive data
    to perform an unattended install.
    example: piranha install autopilot test-server
    example: piranha install autopilot test-server-silent
    example: piranha install autopilot test-server-autogen
    ...
    example: piranha install autopilot *autopilot-file*

    - cherry-pick @todo
    Install indivdual available programs
    example: piranha install cherry-pick
