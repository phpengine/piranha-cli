...
class PiranhaDatabaseInstance extends BasePiranhaDatabaseAllOS {
    ...
    public function askWhetherToCreateInstance($params=null) {
        return $this->performPiranhaDatabaseCreateInstance($params);
    }

    public function askWhetherToDeleteInstance($params=null) {
        return $this->performPiranhaDatabaseDeleteInstance($params);
    }

    protected function performPiranhaDatabaseCreateInstance($params=null){
         ...
         *
            ...
            $database_engine = SharedValidationHelper::validate('database_engine', false, 'string', 'Database Engine') ;
...
//        var_dump($result);
        ...
        for ($checks=1; $checks<200; $checks++) {
            sleep ($wait_period) ;
            $p_api_vars['api_uri'] = '/api/database/instance/modify_status';
    ...
    protected function performPiranhaDatabaseDeleteInstance($params=null){
        if ($this->askForInstanceAddDeleteExecute() != true) {
            return false; }
        $this->initialisePiranha();
        $this->getInstanceID() ;
