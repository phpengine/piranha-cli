...
//
        ...
        if(in_array($action, array("create-hosted-zone", 'ensure-domain-exists'))) {
            ...
            return array ("type"=>"view", "view"=>"PiranhaSMPAPI", "pageVars"=>$this->content);
        }
        ...
        if($action=="list")
        {
            ...
            return array ("type"=>"view", "view"=>"PiranhaSMPList", "pageVars"=>$this->content);
        }
