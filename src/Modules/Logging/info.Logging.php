...
class LoggingInfo extends PTConfigureBase {
  ...
  Logging, logging
        ...
        example: piranha logging log --log-message="Here is something logging to the console and error log"
        example: piranha logging log --php-log --log-message="Here is something logging to the console and error log"
