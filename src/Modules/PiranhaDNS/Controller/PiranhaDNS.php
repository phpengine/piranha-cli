...
//
        ...
        if(in_array($action, array("create-hosted-zone", 'ensure-domain-exists'))) {
            ...
            return array ("type"=>"view", "view"=>"PiranhaDNSAPI", "pageVars"=>$this->content);
        }
        ...
        if($action=="list")
        {
            ...
            return array ("type"=>"view", "view"=>"PiranhaDNSList", "pageVars"=>$this->content);
        }
